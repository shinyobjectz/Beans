...
Ralph stores state in `.beads/` alongside issues:

| File | Purpose |
|------|---------|
| `.beads/current.json` | Active task PRD |
| `.beads/prompt.md` | Claude Code iteration prompt |
| `.beads/progress.txt` | Execution log |
| `.beads/last-research.md` | Gemini research output |
